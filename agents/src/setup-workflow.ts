    ...
    tasks: [
      {
        ...
        body: 'Accept the natural language prediction and structure it into a formal PredictionSpec with deadline, stake amount, and resolution criteria.',
      ...
      },
      {
        ...
        body: 'Search the pool for a human counterparty. If none found, auto-assign the pre-funded agent wallet as the opposing party.',
      },
      {
        name: 'deploy-escrow',
        agentId: deployer.agentId,
        description: 'Deploy escrow and coordinate deposits',
        body: 'Deploy escrow contract via factory on Base, coordinate USDC approvals and deposits from both parties, verify Funded state.',
      },
      {
        name: 'resolve-outcome',
        agentId: resolution.agentId,
        description: 'Resolve prediction via jury',
        body: 'After deadline, run 3-member LLM jury (skeptic, optimist, arbiter), compose UMA claim, submit resolution on-chain.',
      },
    ],
    edges: [
